...
class _MyAccountState extends State<MyAccount> {
  ...
  Future<void> gettingaddresses(userid) async {
    print("I am into Getting address");
    getBillingAddress(userid);
    print("Called Address API");
  }

  Future<void> getOrders() async {
    print("getting Order from the accout page");
    await getMyOrders();
    print("getting orders in account page");
  }
  ...
  void didChangeDependencies() async {
    ...
    print("calling from dependencies");
